...
const DesignerRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`${BASE_URL}/api/register/designer`, form, {
        headers: {
  ...
  const styles = {
    ...
    input: {
      ...
      fontSize: '15px',
      marginBottom: '15px',
      width: '100%', // Ensures inputs take up full width of the form container
      boxSizing: 'border-box', // Prevents inputs from overflowing by including padding and borders in the width
    },
    button: {
      width: '100%',
      padding: '12px',
  ...
  return (
    <div style={styles.container}>
      <div style={styles.formWrapper}>
        <h2 style={styles.title}>Designer Sign Up</h2>
